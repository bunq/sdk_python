...
class ScheduleRequestInquiryBatch(core.BunqModel):
    """
    Used to schedule request inquiry batches.
    
    :type _request_inquiries: list[object_.ScheduleRequestInquiryEntry]
    :type _schedule: object_.Schedule
    :type _total_amount_inquired: object_.Amount
    """
    ...
    # Object type.
    _OBJECT_TYPE = "ScheduleRequestInquiryBatch"
    ...
    def request_inquiries(self):
        """
        :rtype: list[object_.ScheduleRequestInquiryEntry]
        """
...
class ScheduleRequestInquiry(core.BunqModel):
    """
    Used to schedule request inquiry.
    
    :type _request_inquiry: object_.ScheduleRequestInquiryEntry
    :type _schedule: object_.Schedule
    """

    # Field constants.
    FIELD_REQUEST_INQUIRY = "request_inquiry"
    FIELD_SCHEDULE = "schedule"

    # Object type.
    _OBJECT_TYPE = "ScheduleRequestInquiry"

    def __init__(self):
        self._request_inquiry = None
        self._schedule = None
    ...
    def request_inquiry(self):
        """
        :rtype: object_.ScheduleRequestInquiryEntry
        """
